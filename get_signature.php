...
<html lang="en" dir="ltr">
    ...
    <body>
        <div class="container">
            ...
            <ul>
                <li><input type="checkbox" name="cap_consent"> I consent for my signature to be electronically captured and affixed
                 to the copy of my prescription shown here.
                <li><input type="checkbox" name="ack"> I acknowledge my prescription was issued to me at the conclusion of my examination.
            </ul>
            <hr>
            Insert Signature Pad Here...
            <hr>
